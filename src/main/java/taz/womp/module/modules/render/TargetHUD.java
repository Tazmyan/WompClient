...
public final class TargetHUD extends Module {
    ...
    public void a(final Render2DEvent render2DEvent) {
        ...
        if (TargetHUD.fadeProgress < 0.99f && b) {
            ...
            final boolean isBot = AntiBot.isABot((PlayerEntity) getAttacking);
            final boolean antiBotEnabled = Womp.INSTANCE.MODULE_MANAGER.getModuleByClass(AntiBot.class) != null && Womp.INSTANCE.MODULE_MANAGER.getModuleByClass(AntiBot.class).isEnabled();
            if (!(antiBotEnabled && isBot)) {
                ...
                this.renderTargetHUD(a, f, f2, (PlayerEntity) getAttacking, playerListEntry, n2, h, i, isBot);
                matrices.pop();
            }
        }
    ...
    private void renderTargetHUD(final DrawContext drawContext, final int n, final int n2, final PlayerEntity playerEntity, final PlayerListEntry playerListEntry, final float n3, final Color color, final Color color2, boolean isBot) {
        ...
        final int n5 = n2 + 120;
        String pingText = "N/A";
        Color pingColor = color3;
        if (playerListEntry != null) {
            pingText = playerListEntry.getLatency() + "ms";
            pingColor = this.a(playerListEntry.getLatency(), n3);
        }
        this.a(drawContext, n + 15, n5, 80, 45, "PING", pingText, pingColor, color3, n3);
        String s2 = isBot ? "BOT" : "PLAYER";
        Color color4 = isBot ? new Color(255, 100, 100, (int) (255.0f * n3)) : new Color(100, 255, 100, (int) (255.0f * n3));
