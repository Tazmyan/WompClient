...
import taz.womp.event.events.PostItemUseEvent;
...
public class FastPlace extends Module {
    private final BooleanSetting onlyXP = new BooleanSetting(EncryptedString.of("Only XP"), false);
    private final BooleanSetting allowBlocks = new BooleanSetting(EncryptedString.of("Blocks"), true);
    private final BooleanSetting allowItems = new BooleanSetting(EncryptedString.of("Items"), true);
    private final NumberSetting useDelay = new NumberSetting(EncryptedString.of("Delay"), 0.0, 10.0, 0.0, 1.0);
