...
public final class ConfigManager {
    ...
    public void loadProfile() {
        try {
            ...
            for (final Module next : Womp.INSTANCE.getModuleManager().c()) {
                ...
                if (value != null) {
                    ...
                    if (value2 != null && value2.isJsonPrimitive()) {
                        boolean shouldEnable = value2.getAsBoolean();
                        next.setEnabled(shouldEnable);
                    }
    ...
    public void shutdown() {
        try {
            this.jsonObject = new JsonObject();
            for (final Module module : Womp.INSTANCE.getModuleManager().c()) {
    ...
    public void loadFromString(String json) {
        try {
            this.jsonObject = com.google.gson.JsonParser.parseString(json).getAsJsonObject();
            loadProfile();
        } catch (Exception e) {
            e.printStackTrace();
        }
