...
import taz.womp.mixin.MinecraftClientAccessor;
import taz.womp.mixin.MouseHandlerAccessor;
...
public final class MouseSimulation {
    ...
    public static MouseHandlerAccessor getMouseHandler() {
        return (MouseHandlerAccessor) ((MinecraftClientAccessor) Womp.mc).getMouse();
    }
    ...
    public static void mousePress(int keyCode) {
        ...
        getMouseHandler().invokeOnMouseButton(Womp.mc.getWindow().getHandle(), keyCode, GLFW.GLFW_PRESS, 0);
    }

    public static void mouseRelease(int keyCode) {
        getMouseHandler().invokeOnMouseButton(Womp.mc.getWindow().getHandle(), keyCode, GLFW.GLFW_RELEASE, 0);
    }
